...
var app = {
    ...
    blog: function(){
        function getBlogs() {
            var dfd = $.Deferred();
            $.ajax({
                //url: 'http://10.0.2.2/wordpress/?json=1',
                url: 'http://luca-favard.com/wordpress/wordpress/?json=1',
                timeout:5000,
                type: 'GET',
                dataType: 'json',
    ...
    portfolio: function(){
        $.ajax({
            //url: 'http://10.0.2.2/wordpress/?json=get_type_posts&post_type="portfolio"',
            url: 'http://luca-favard.com/wordpress/wordpress/?json=get_type_posts&post_type="portfolio"',
            type: 'GET',
            dataType: 'json',
            success: function(data){
